        ...
        <div class="container box_1620">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav justify-content-center">
              ...
              <li class="nav-item"><a class="nav-link" href="archive.html">Danh Mục</a></li> 
              <li class="nav-item"><a class="nav-link" href="category.html">Thời Sự</a>
              <li class="nav-item submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                  aria-expanded="false">Pages</a>
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="blog-details.html">VĂN HÓA</a></li>
                </ul>
              </li>
              <li class="nav-item"><a class="nav-link" href="/giatri">Giải Trí</a></li>
        ...
        <c:forEach var="tintucs" items="${tintucs}">
          <div class="card blog__slide text-center">
            <div class="blog__slide__img">
              <img style="width: 330px; margin-right: 30px;" class="card-img rounded-0" src="../static/img/blog/${tintucs.hinhanh}" alt="">
            </div>
            <div class="blog__slide__content">
              <a class="blog__slide__label" href="#">Thời Sự</a>
              <h3><a href="#">${tintucs.tieude}</a></h3>
              <p>2 days ago</p>
            </div>
          </div>
          </c:forEach>
          ...
          <div class="col-lg-8">
           ...
           <c:forEach var="tintucs" items="${tintucs}">
            <div class="single-recent-blog-post">
              <div class="thumb">
                <img class="img-fluid" src="../static/img/blog/${tintucs.hinhanh}" alt="">
                <ul class="thumb-info">
              ...
              <div class="details mt-20">
                <a href="blog-single.html">
                  <h3>${tintucs.tieude}</h3>
                </a>
                <p class="tag-list-inline">Tag: <a href="#">travel</a>, <a href="#">life style</a>, <a href="#">technology</a>, <a href="#">fashion</a></p>
                <p>${tintucs.tomtatnoidung}</p>
                ...
                <div class="single-sidebar-widget popular-post-widget">
                  ...
                  <div class="popular-post-list">
                    <div class="single-post-list">
                      <div class="thumb">
                        <img class="card-img rounded-0" src="../static/img/blog/thumb/thumb1.png" alt="">
                        <ul class="thumb-info">
                    ...
                    <div class="single-post-list">
                      <div class="thumb">
                        <img class="card-img rounded-0" src="../static/img/blog/thumb/thumb2.png" alt="">
                        <ul class="thumb-info">
                          <li><a href="#">Adam Colinge</a></li>
                          <li><a href="#">Dec 15</a></li>
                        </ul>
                    ...
                    <div class="single-post-list">
                      <div class="thumb">
                        <img class="card-img rounded-0" src="../static/img/blog/thumb/thumb3.png" alt="">
                        <ul class="thumb-info">
                          <li><a href="#">Adam Colinge</a></li>
                          <li><a href="#">Dec 15</a></li>
                        </ul>
